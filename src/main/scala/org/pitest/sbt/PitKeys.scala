...
private[sbt] case class Options(
                                 ...
                                 mutateStaticInitializers : Boolean,
                                 threads : Int,
...
object PitKeys {
    ...
    val mutationThreshold = SettingKey[Int]("pit-mutation-threshold")
    val coverageThreshold = SettingKey[Int]("pit-coverage-threshold")
